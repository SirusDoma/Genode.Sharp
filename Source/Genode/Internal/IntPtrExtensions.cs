...
namespace Genode
{
    ...
    {
        public static IntPtr Add(IntPtr pointer, Int32 value)
        {
            unchecked
            {
                switch (IntPtr.Size)
        ...
        public static IntPtr Add(IntPtr pointer, Int64 value)
        {
            unchecked
            {
                switch (IntPtr.Size)
        ...
        public static IntPtr Substract(IntPtr pointer, Int32 value)
        {
            unchecked
            {
                switch (IntPtr.Size)
        ...
        public static IntPtr Substract(IntPtr pointer, Int64 value)
        {
            unchecked
            {
                switch (IntPtr.Size)
